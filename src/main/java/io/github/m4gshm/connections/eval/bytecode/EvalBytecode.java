...
//    public Map<CallCacheKey, Result> callCache;
    @Getter
...
//        this.callCache = callCache;
    ...
    static List<EvalArguments> evalArguments(CallPoint calledMethod, EvalBytecode eval, Map<CallCacheKey, Result> callCache) {
